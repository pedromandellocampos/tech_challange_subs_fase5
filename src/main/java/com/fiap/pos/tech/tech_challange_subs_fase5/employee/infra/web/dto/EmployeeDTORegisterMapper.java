...
public interface EmployeeDTORegisterMapper {
  ...
  EmployeeDTO toDto(EmployeeDTORegister employeeDTORegister);
  @Mapping(source="dateOfBirth" , target ="dateOfBirth", dateFormat = "dd/MM/yyyy")
  @Mapping(source="hireDate" , target ="hireDate", dateFormat = "dd/MM/yyyy")
  EmployeeDTORegister toDtoRegister(EmployeeDTO employeeDTO);
}
