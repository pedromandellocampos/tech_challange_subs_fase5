...
public interface EmployeeDTOToReturnMapper {
  ...
  EmployeeDTOToReturn toDto(EmployeeDTO employeeDTO);
  @Mapping(source="dateOfBirth" , target ="dateOfBirth", dateFormat = "dd/MM/yyyy")
  @Mapping(source="hireDate" , target ="hireDate", dateFormat = "dd/MM/yyyy")
  EmployeeDTO toEntity(EmployeeDTOToReturn employeeDTOToReturn);
}
